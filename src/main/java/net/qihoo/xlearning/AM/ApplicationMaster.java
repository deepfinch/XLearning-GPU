...
public class ApplicationMaster extends CompositeService {
  ...
  private ApplicationMaster() {
    ...
    workerGpus = conf.getInt(XLearningConfiguration.XLEARNING_WORKER_GPUS, XLearningConfiguration.DEFAULT_XLEARNING_WORKER_GPUS);
  ...
  private void buildContainerRequest() {
    ...
    workerCapability.setGPUs(workerGpus);
    // TODO: add support of gpu with locality
    workerCapability.setGPUAttribute((long)0);
    ...
    if (("TENSORFLOW".equals(xlearningAppType) && !single) || ("MXNET".equals(xlearningAppType) && !singleMx)) {
      ...
      psCapability.setGPUs(workerGpus);
      // TODO: add support of gpu with locality
      psCapability.setGPUAttribute((long)0);
